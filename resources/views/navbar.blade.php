<nav class=" bg-white max-w-7xl flex relative justify-between items-center mx-auto h-20">
    <!-- logo -->
        ...
        <div class="inline-block">
            <div class="inline-flex items-center max-w-full">
                <button class="flex items-center flex-grow-0 flex-shrink pl-2 relative w-60 border rounded-full px-1  py-1" type="button">
                    <div class="block flex-grow flex-shrink overflow-hidden"></div>
        ...
        <div class="flex justify-end items-center relative">
            ...
            <div class="flex mr-4 items-center">
                <a class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                    <div class="flex items-center relative cursor-pointer whitespace-nowrap">Ajouter un article</div>
                </a>
